    ...
    <section id="about-me" class="relative scroll-mt-16">
      ...
      <div class="lg:grid-cols-desktop grid grid-cols-1 gap-x-10 gap-y-6">
        ...
        <div class="grid grid-cols-2 gap-6 sm:grid-cols-3">
          <ul>
            <li>
              <Skill icon={IconReact} title="React" level={7} />
              <Skill icon={IconFresh} title="Fresh" level={7} />
              <Skill icon={IconVue} title="Vue" level={10} />
            </li>
          </ul>
          <ul>
            <li>
              <Skill icon={IconTypescript} title="TypeScript" level={10} />
              <Skill icon={IconGolang} title="Golang" level={5} />
              <Skill icon={IconPython} title="Python" level={6} />
            </li>
          </ul>
          <ul>
            <li>
              <Skill icon={IconRust} title="Rust" level={3} />
            </li>
          </ul>
        </div>
      </div>
